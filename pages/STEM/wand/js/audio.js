export class GameAudio {
  ...
  play(type) {
    ...
    const sounds = {
      ...
      powerUp: [[520, 0.07, "triangle", 0.04], [880, 0.14, "sine", 0.05, 0.07]],
      extraLife: [[660, 0.08, "sine", 0.04], [990, 0.12, "triangle", 0.05, 0.09], [1320, 0.16, "sine", 0.04, 0.2]],
      shieldBlock: [[160, 0.08, "square", 0.05], [420, 0.1, "triangle", 0.05, 0.08]],
